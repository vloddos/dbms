...
public final class DBRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataBases.useDataBase("tdb").createTable("student", map);*/

        System.out.println(DataBases.getCurrentDataBase().getTable("student"));
        //System.out.println(DataBases.getCurrentDataBase().getTable("student").fieldDescriptions.size());
