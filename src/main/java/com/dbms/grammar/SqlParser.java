...
public class SqlParser implements SqlParserConstants {
    ...
    final public ArgsGuard parse() throws Exception {
        ArgsGuard args = null;
        if (jj_2_1(2)) {
    ...
    final public ArgsGuard parseCreateDatabase() throws Exception {
        Token name;
    ...
    final public ArgsGuard parseUseDatabase() throws Exception {
        Token name;
        ArgsGuard args = new ArgsGuard();
    ...
    final public ArgsGuard parseCreateTable() throws Exception {
        Token name;
        ArgsGuard args = new ArgsGuard();
        jj_consume_token(CREATE);
    ...
    final public ArgsGuard parseShowCreateTable() throws Exception {
        Token name;
        ArgsGuard args = new ArgsGuard();
    ...
    final public ArgsGuard parseInsertIntoTable() throws Exception {
        Token name;
    ...
    final public ArgsGuard parseSelectFromTable() throws Exception {
    ...
    final public ArgsGuard parseUpdate() throws Exception {
    ...
    final public ArgsGuard parseDelete() throws Exception {
    ...
    private boolean jj_3_26() {
        return jj_scan_token(MATH_OPERATION_LITEARAL);
    }
    ...
    private boolean jj_3_43() {
        if (jj_scan_token(COMMA)) return true;
        return jj_scan_token(SINGLE_MARK);
    }
