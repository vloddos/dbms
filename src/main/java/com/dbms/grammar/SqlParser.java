...
//____________________________________________Here helper methods____________________________________________
  ...
  final public Map<String, Type> getFields() throws ParseException {
    Token name, TypeName;
    Type type;
  ...
  final public Type getTypeDescription() throws ParseException {
    ...
    if (jj_2_51(2)) {
      ...
      ;
        ...
        typeDescription = new Type(type.image);
