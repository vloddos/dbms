...
*/
  ...
  final public void parseExit() throws ParseException {
    Token commandName;
    commandName = jj_consume_token(EXIT);
  ...
  final public TypeDescription getTypeDescription() throws ParseException {
    ...
    Token length = null;
    tokenDefinitionType = jj_consume_token(DATA_TYPE);
    if (jj_2_12(2)) {
      jj_consume_token(OPEN_BRACKET);
